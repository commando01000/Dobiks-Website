<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-category')): ?>
    <a class="btn btn-sm small btn btn-primary" href="<?php echo e(route('blog-category.edit', $category->id)); ?>" data-bs-toggle="tooltip"
...
<?php endif; ?>
<?php /**PATH G:\xampp\htdocs\Dashboard_Project\resources\views/back/blog-category/action.blade.php ENDPATH**/ ?>