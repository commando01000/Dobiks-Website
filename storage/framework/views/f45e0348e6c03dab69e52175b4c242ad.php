                            ...
                            <div class="tab-pane fade show active" id="apps-setting" role="tabpanel"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <?php echo e(Form::label('who we are link', __('who_we_are_link'), ['class' => 'form-label'])); ?>

                                                <?php echo Form::text('who_we_are_link', Utility::getsettings('who_we_are_link'), [
                                                    'class' => 'form-control',
                                                    'rows' => '3',
                                                    'placeholder' => __('Enter app detail'),
                                                ]); ?>
...
<?php echo $__env->make('layouts.back.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\al shrouk academy\radwa\furniture project\Dashboard\resources\views/back/landing-page/app-setting.blade.php ENDPATH**/ ?>