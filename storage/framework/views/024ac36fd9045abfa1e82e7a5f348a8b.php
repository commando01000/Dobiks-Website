        ...
        <div class="row mb-3">
            <div class="col-lg-12">
                <div class="float-left">
                    <a href="<?php echo e(route('service-category.create')); ?>"
                        ...
                        <td>
                            <label class="form-switch">
                                <input class="form-check-input changeStatus" name="custom-switch-checkbox"
                                    ...
                                    data-url="<?php echo e(route('servicecategory.status', $category->id)); ?>" type="checkbox">
                            </label>
                        </td>
...
<?php echo $__env->make('layouts.back.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\Dashboard_Project\resources\views/back/service-category/index.blade.php ENDPATH**/ ?>