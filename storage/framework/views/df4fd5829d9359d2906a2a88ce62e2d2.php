                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        ?>
                                        <?php echo Form::textarea('description', $var, [
                                            'class' => 'form-control ',
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <?php echo e(Form::label('body', __('Optional Field '), ['class' => 'form-label'])); ?> *
                                        <?php
...
<?php echo $__env->make('layouts.back.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\al shrouk academy\radwa\furniture project\Dashboard\resources\views/back/project/view.blade.php ENDPATH**/ ?>