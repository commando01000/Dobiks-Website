                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('title', $project->title, ['class' => 'form-control','placeholder' => __('Enter title'),'required' => 'required']); ?>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('client', $project->client, ['class' => 'form-control','placeholder' => __('Enter Client Name')]); ?>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('project_location', $project->project_location, ['class' => 'form-control','placeholder' => __('Enter Project Location')]); ?>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('project_timeframe', $project->project_timeframe, ['class' => 'form-control','placeholder' => __('Enter Project Timeframe')]); ?>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('project_date', $project->project_date, ['class' => 'form-control','placeholder' => __('Enter Project Date')]); ?>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('embed', $project->embed ?? "", ['class' => 'form-control','placeholder' => __('Enter video embed ')]); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select  name="category_id" id="" class="form-control" required>
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>" <?php if($project->project_category == $category->id): ?>
                                                <?php echo e('selected'); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    *
                                    <?php echo Form::textarea('description', $project->description, ['class' => 'form-control ','placeholder' => __('Enter short description')]); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::textarea('body', $project->body, [
                                        'class' => 'form-control ',
...
<?php echo $__env->make('layouts.back.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\Dashboard_Project\resources\views/back/project/edit.blade.php ENDPATH**/ ?>