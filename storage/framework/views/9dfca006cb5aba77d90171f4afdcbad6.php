                            ...
                            <div class="col-md-3">
                                <div class="content-section__column--secondary">
                                    <p class="content-section__button pt-2 ui text size-btn_text">
                                        <a class="text-decoration-none text-white" href="<?php echo e(route('contact')); ?>">CONTACT US</a>
                                    </p>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\Dashboard_Project\resources\views/front/about-us/index.blade.php ENDPATH**/ ?>