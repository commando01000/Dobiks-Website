            ...
            <ul class="dash-navbar d-block">
                ...
                <li class="dash-item dash-hasmenu collapsed <?php echo e(request()->is('modules*') ? 'dash-trigger' : ''); ?>">
                    ...
                    <ul class="dash-submenu">
                        ...
                        <li class="dash-item ">
                            <a class="dash-link" href="<?php echo e(route('leadership.index')); ?>"><?php echo e(__('clients')); ?></a>
                        </li>
...
<?php /**PATH G:\xampp\htdocs\Dashboard_Project\resources\views/layouts/back/sidebar.blade.php ENDPATH**/ ?>