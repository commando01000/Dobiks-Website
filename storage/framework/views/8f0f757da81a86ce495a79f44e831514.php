<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-category')): ?>
    <a class="btn btn-sm small btn btn-primary" href="<?php echo e(route('project-category.edit', $category->id)); ?>" data-bs-toggle="tooltip"
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-category')): ?>
    <?php echo Form::open([
        'method' => 'DELETE',
        'class' => 'd-inline',
        'route' => ['project-category.destroy', $category->id],
...
<?php endif; ?>
<?php /**PATH D:\company\backend\resources\views/back/project-category/action.blade.php ENDPATH**/ ?>