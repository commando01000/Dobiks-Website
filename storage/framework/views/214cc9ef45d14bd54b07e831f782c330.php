...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Section-Projects -->
    <section id="section-projects" class="column_three">
        <div class="section-projects">
            <h2 class="section-projects__title ui heading size-headinglg">
                <span class="section-projects__title-span">
                    Our Latest&nbsp;</span>
                <span class="section-projects__title-span-1"> Projects</span>
            </h2>
            ...
            <ul class="nav nav-pills section__tabs" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-decoration-none section__tab-item active"
                        ...
                        aria-controls="pills-creative-design" aria-selected="true" tabindex="0"
                        style="cursor: pointer">
                        Creative Designs
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link text-decoration-none section__tab-item" id="pills-motion-graphics-clients-tab"
                        data-bs-toggle="pill" data-bs-target="#pills-motion-graphics-clients" type="button"
                        role="tab" aria-controls="pills-motion-graphics-clients" aria-selected="false"
                        tabindex="0" style="cursor: pointer">
                        Motion Graphics
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link section__tab-item" id="pills-video-shooting-clients-tab"
                        data-bs-toggle="pill" data-bs-target="#pills-video-shooting-clients" type="button"
                        role="tab" aria-controls="pills-video-shooting-clients" aria-selected="false">
                        Video Shooting
                    </button>
                </li>
                <li class="nav-item" role="presentation">
            ...
            <div class="tab-content w-100" id="pills-tabContent">
              ...
              ">
                                    <div class="card-image w-100 h-100">
                                        <img src="<?php echo e(asset('assets/front_assets/images/img_01_1.png')); ?>" class="w-100"
                                            alt="item" />
                                    </div>
                                </div>
                            </div>
              ...
              ">
                                    <div class="card-image w-100 h-100">
                                        <img src="<?php echo e(asset('assets/front_assets/images/img_02.png')); ?>" class="w-100"
                                            alt="item" />
                                    </div>
                                </div>
                            </div>
              ...
              ">
                                    <div class="card-image w-100 h-100">
                                        <img src="<?php echo e(asset('assets/front_assets/images/img_03.png')); ?>" class="w-100"
                                            alt="item" />
                                    </div>
                                </div>
                            </div>
              ...
              ">
                                    <div class="card-image w-100 h-100">
                                        <img src="<?php echo e(asset('assets/front_assets/images/img_04_2.png')); ?>" class="w-100"
                                            alt="item" />
                                    </div>
                                </div>
                            </div>
              ...
              ">
                                    <div class="card-image w-100 h-100">
                                        <img src="<?php echo e(asset('assets/front_assets/images/img_05.png')); ?>" class="w-100"
                                            alt="item" />
                                    </div>
                                </div>
                            </div>
