            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h4 class="m-b-10"><?php echo e(__('Gallery Categories')); ?></h4>
                    </div>
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><?php echo e(__('Gallery Categories')); ?></li>
                    </ul>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.back.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\company\backend\resources\views/back/gallery-category/index.blade.php ENDPATH**/ ?>