                ...
                <div class="container">
                    ...
                    <div class="row mt-5">
                        <?php $__currentLoopData = $leaderships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $leadership): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-3">
                                <a href="<?php echo e(route('team-details', $leadership->id)); ?>" class="user-profile-link">
                                    <div class="user-profile">
                                        <img src="<?php echo e(Storage::url($leadership->photo)); ?>" alt="<?php echo e($leadership->name); ?>"
...
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\al shrouk academy\radwa\furniture project\Dashboard\resources\views/front/about-us/index.blade.php ENDPATH**/ ?>