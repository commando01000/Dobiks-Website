...
<body>
    ...
    <div class="auth-wrapper auth-v3">
        <!--header start here-->
        <?php echo $__env->make('layouts.login.app-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!--header end here-->
    ...
    <!--footer_ start here-->
    <?php echo $__env->make('layouts.login.app-footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--footer_ end here-->
    <!--scripts start here-->
...
<?php /**PATH G:\al shrouk academy\radwa\furniture project\Dashboard\resources\views/layouts/login/app.blade.php ENDPATH**/ ?>