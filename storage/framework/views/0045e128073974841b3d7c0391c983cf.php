                ...
                <section class="big-carousel-section-phone d-none">
                    <div class="container-fluid">
                        <div id="carouselExample3Autoplaying"
                            ...
                            <div class="carousel-inner">
                                <!-- First carousel item with your existing content -->
                                <?php $__currentLoopData = $sliders->chunk(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="carousel-item <?php if($loop->first): ?> active <?php endif; ?> ">
                                        <div style="z-index: 99999" class="row flex-wrap gy-2 align-items-center">
                                            <div class="col-md-12 col-sm-12">
                                                <div class="row gy-4">
...
<?php echo $__env->make('layouts.front.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\al shrouk academy\radwa\furniture project\Dashboard\resources\views/front/home/index.blade.php ENDPATH**/ ?>