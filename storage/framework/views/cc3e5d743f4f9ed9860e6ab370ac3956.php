            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <?php echo Form::model($category, [
                        'route' => ['project-category.update', $category->id],
                        'method' => 'PUT',
                        'data-validate',
                    ]); ?>
...
<?php echo $__env->make('layouts.back.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\company\backend\resources\views/back/project-category/edit.blade.php ENDPATH**/ ?>