...
<?php $__env->startSection('breadcrumb'); ?>
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10"><?php echo e(__('Create Project')); ?></h4>
        </div>
        <ul class="breadcrumb">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('client', null, ['class' => 'form-control', 'placeholder' => __('Enter Client Name')]); ?>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('project_location', null, [
                                        'class' => 'form-control',
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('project_timeframe', null, [
                                        'class' => 'form-control',
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('project_date', null, ['class' => 'form-control', 'placeholder' => __('Enter Project Date')]); ?>
...
<?php echo $__env->make('layouts.back.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\Dashboard_Project\resources\views/back/project/create.blade.php ENDPATH**/ ?>