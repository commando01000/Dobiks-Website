            ...
            <div class="tab-content w-100" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-creative-design-clients" role="tabpanel"
                    ...
                    <div class="container">
                      ...
                      ">
                                    <div class="card-image w-100 h-100">
                                        <img src="<?php echo e(asset('front_assets/images/img_04_2.png')); ?>" class="w-100"
                                            alt="item" />
                                    </div>
                                </div>
                            </div>
                      ...
                      ">
                                    <div class="card-image w-100 h-100">
                                        <img src="<?php echo e(asset('front_assets/images/img_05.png')); ?>" class="w-100"
                                            alt="item" />
                                    </div>
                                </div>
                            </div>
            ...
            <div class="section-projects__actions w-100">
                <div class="section-projects__action-row">
                    <div class="section__call-to-action-row">
                        ...
                        <img src="<?php echo e(asset('front_assets/images/img_arrow.svg')); ?>" alt="arrow image"
