...
<?php $__env->startSection('breadcrumb'); ?>
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10"><?php echo e(__('edit Service')); ?></h4>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item"><?php echo Html::link(route('home'), __('Dashboard'), []); ?></li>
            <li class="breadcrumb-item"><a href="<?php echo e(route('service-category.index')); ?>"><?php echo e(__('Service')); ?></a></li>
            <li class="breadcrumb-item active"><?php echo e(__('edit Service')); ?></li>
        </ul>
    </div>
            ...
            <div class="m-auto col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5> <?php echo e(__('edit Service')); ?></h5>
                    </div>
                    <?php echo Form::open([
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::text('slug', $service->slug, [
                                        'class' => 'form-control',
                                    ...
                                    <select name="category_id" id="" class="form-control" required>
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($category->id); ?>"
                                                <?php if($service->service_category == $category->id): ?> <?php echo e('selected'); ?> <?php endif; ?>>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::textarea('body', $service->description, [
                                        'class' => 'form-control ',
...
<?php echo $__env->make('layouts.back.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\al shrouk academy\radwa\furniture project\Dashboard\resources\views/back/service/edit.blade.php ENDPATH**/ ?>