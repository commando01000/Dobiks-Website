                                        ...
                                        <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                            <ul class="navbar-nav header__nav-list me-auto mb-2 mb-lg-0">
                                                ...
                                                <li class="nav-item dropdown">
                                                    <a class="nav-link nav-list__item--about ui text size-texts dropdown-toggle <?php echo e(Route::is('services') ? 'active' : ''); ?>"
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li><a class="dropdown-item"
                                                                    href="<?php echo e(route('see.all.projects', $category->id)); ?>"><?php echo e($category->name); ?></a>
                                                            </li>
