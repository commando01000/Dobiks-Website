        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                <a class="navbar-brand" href="#"><img class="logo"
                        src="<?php echo e(asset('assets/front_assets/images/img_header_logo.png')); ?>" alt="Dopiks"></a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                    data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false"
                    aria-label="Toggle navigation">
                    <img class="img-fluid" src="<?php echo e(asset('assets/front_assets/images/hamburger-icon.png')); ?>"
                        alt="menu">
                </button>
                    ...
                    <ul class="navbar-nav ms-auto gap-3 text-center text-lg-start">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <?php $__currentLoopData = $services_header; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a class="dropdown-item"
                                            href="<?php echo e(route('view.service', $service->slug)); ?>"><?php echo e($service->title); ?></a>
                                    </li>
                    ...
                    <div class="container">
                        <div class="text-center">
                            <img class="img-fluid form-logo"
                                src="<?php echo e(asset('assets/front_assets/images/img_header_logo.png')); ?>" alt="logo">
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-center gap-3">
                            <a href="#" class="bg-gray hover-orange rounded-circle px-2 py-1">
                                <img class="img-fluid" src="<?php echo e(asset('assets/front_assets/images/facebook.svg')); ?>"
                                    alt="facebook">
                            </a>
                            <a href="#" class="bg-gray hover-orange rounded-circle px-2 py-1">
                                <img class="img-fluid" src="<?php echo e(asset('assets/front_assets/images/linkedin.svg')); ?>"
                                    alt="linkedin">
                            </a>
                            <a href="#" class="bg-gray hover-orange rounded-circle px-2 py-1">
                                <img class="img-fluid" src="<?php echo e(asset('assets/front_assets/images/twitter.svg')); ?>"
                                    alt="twitter">
                            </a>
                        </div>
                    </div>
