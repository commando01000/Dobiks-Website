                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <?php echo e(Form::label('service_status', __('service_status'), ['class' => 'form-label'])); ?>

                                        *
                                        <?php echo Form::text('service_status', $service->service_status, [
                                            'class' => 'form-control',
                                            'disabled',
                                        ]); ?>
...
<?php echo $__env->make('layouts.back.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\Dashboard_Project\resources\views/back/service/view.blade.php ENDPATH**/ ?>