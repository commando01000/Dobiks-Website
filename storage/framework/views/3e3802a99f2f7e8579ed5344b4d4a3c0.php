                        ...
                        <header id="header" class="header">
                            <nav class="navbar w-100 shadow navbar-expand-lg">
                                <div
                                    ...
                                    <a href="<?php echo e(route('homepage')); ?>" class="navbar-brand" href="#">
                                        ...
                                        <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                            <ul class="navbar-nav header__nav-list me-auto mb-2 mb-lg-0">
                                                ...
                                                <li class="nav-item dropdown">
                                                    <a class="nav-link nav-list__item--about ui text size-texts dropdown-toggle text-center <?php echo e(Route::is('services') || Route::is('view.service') ? 'active' : ''); ?>"
...
<?php /**PATH G:\al shrouk academy\radwa\furniture project\Dashboard\resources\views/layouts/front/header.blade.php ENDPATH**/ ?>