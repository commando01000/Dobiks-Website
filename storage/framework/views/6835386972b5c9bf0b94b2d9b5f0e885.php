        ...
        <div class="row mb-3">
            <div class="col-lg-12">
                ...
                <div class="float-left">
                    <a href="<?php echo e(route('client-category.create')); ?>"
                        ...
                        <td>
                            <label class="form-switch">
                                <input class="form-check-input changeStatus" name="custom-switch-checkbox"
                                    ...
                                    data-url="<?php echo e(route('client-category.status', $category->id)); ?>" type="checkbox">
                            </label>
                        </td>
                        <td><?php echo e(\App\Facades\UtilityFacades::date_time_format($category->created_at)); ?></td>
                        <td>

                            <a href="<?php echo e(route('client-category.edit', $category->id)); ?>"
                                class="btn btn-warning"><?php echo e(__('Edit')); ?></a>
                            <form action="<?php echo e(route('client-category.destroy', $category->id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.back.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xampp\htdocs\Dashboard_Project\resources\views/back/client-category/index.blade.php ENDPATH**/ ?>