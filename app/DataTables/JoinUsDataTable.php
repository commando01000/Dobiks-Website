...
class JoinUsDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addIndexColumn()
            ->addColumn('action', function (Join $join) {
                return view('back/joinUs.action', compact('join'));
            })
    ...
    {
        return [
            Column::make('DT_RowIndex')->title('#')->data('DT_RowIndex')->searchable(false)->orderable(false),
