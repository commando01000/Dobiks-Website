...
<style>
    .navbar-content {
        height: 100%; /* Set a specific height for the navbar-content */
            ...
            <ul class="dash-navbar d-block">
                ...
                <li class="dash-item dash-hasmenu collapsed {{ request()->is('blog*') ? 'dash-trigger' : '' }}">
                    ...
                    <ul class="dash-submenu">
                        ...
                        <li class="dash-item ">
                            <a class="dash-link" href="{{ route('blog-category.index') }}">{{ __('Blog Category') }}</a>
                        </li>
                    </ul>
                </li>
                @endcanany
                ...
                <li class="dash-item dash-hasmenu collapsed {{ request()->is('gallery*') ? 'dash-trigger' : '' }}">
                    ...
                    <ul class="dash-submenu">
                        ...
                        <li class="dash-item ">
                            <a class="dash-link" href="{{ route('gallery-category.index') }}">{{ __('Gallery Category') }}</a>
                        </li>
                    </ul>
                </li>
                @endcanany
                ...
                <li class="dash-item dash-hasmenu collapsed {{ request()->is('modules*') ? 'dash-trigger' : '' }}">
                    ...
                    <ul class="dash-submenu">
                        ...
                        <li class="dash-item ">
                            <a class="dash-link" href="{{ route('project-category.index') }}">{{ __('categoris') }}</a>
                        </li>
                        {{-- <li class="dash-item ">
                        ...
                        <li class="dash-item ">
                            <a class="dash-link" href="{{ route('business.growth.index') }}">{{ __('Bussiness Growth') }}</a>
                        </li>
                        <li class="dash-item ">
                ...
                <li class="dash-item dash-hasmenu collapsed {{ request()->is('settings*') ? 'dash-trigger' : '' }}">
                    ...
                    <ul class="dash-submenu">
                        ...
                        <li class="dash-item ">
                            <a class="dash-link" href="{{ route('manage.language', ['lang' => 'en']) }}">{{ __('Language') }}</a>
                        </li>
                        <li class="dash-item ">
                ...
                <li class="dash-item dash-hasmenu">
                    <a  href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();" class="dash-link" >
                       <span class="dash-micon">
