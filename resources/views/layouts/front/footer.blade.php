    ...
    <footer class="py-5 bg-dark-black">
        <div class="container">
            <img class="logo img-fluid mb-4" src="{{ asset('assets/front_assets/images/img_footer_logo.png') }}" alt="Dopiks">
            <div class="row">
                <div class="col-lg-5 mb-4 d-flex flex-column justify-content-between gap-4">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <a href="#" class="bg-gray hover-orange rounded-circle px-2 py-1">
                            <img class="img-fluid" src="{{ asset('assets/front_assets/images/facebook.svg') }}" alt="facebook">
                        </a>
                        <a href="#" class="bg-gray hover-orange rounded-circle px-2 py-1">
                            <img class="img-fluid" src="{{ asset('assets/front_assets/images/linkedin.svg') }}" alt="linkedin">
                        </a>
                        <a href="#" class="bg-gray hover-orange rounded-circle px-2 py-1">
                            <img class="img-fluid" src="{{ asset('assets/front_assets/images/twitter.svg') }}" alt="twitter">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 mb-4 text-capitalize  d-flex flex-column gap-4">
                    <div>
                        ...
                        <ul>
                            <li><a class="fs-4 fw-medium number" href="#">(+20) 262-2578</a></li>
                            <li><a class="fs-4 fw-medium number" href="#">(+20) 262-2578</a></li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul>
                            <li class="number">61973 State 415 Rte, Cohocton, New York 14826, USA</li>
                        </ul>
                    </div>
                </div>
            </div>
