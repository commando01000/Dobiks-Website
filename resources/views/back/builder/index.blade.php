...
<head>
    ...
    <title>{{@$title}}</title>
    <link href="{{asset('assets/builder/css/pagebuilder.min.css')}}" rel="stylesheet">
    <link href="{{asset('assets/builder/css/pb-preset.min.css')}}" rel="stylesheet">
    <link href="{{asset('assets/builder/css/pb-shell.css')}}" rel="stylesheet">
    <script src="{{asset('assets/builder/js/core/jquery.3.2.1.min.js')}}"></script>
    <script src="{{asset('assets/builder/js/plugin/pagebuilder/main.min.js')}}"></script>
    <script src="{{asset('assets/builder/js/plugin/pagebuilder/plugins.min.js')}}"></script>
  ...
  <body>
    ...
    <div class="request-loader">
        <img src="{{asset('assets/builder/img/loading.gif')}}" alt="">
    </div>
    {{-- Toast Alert --}}
    ...
    <script type="text/javascript">
      ...
      var editor  = grapesjs.init({
        ...
        canvas: {
            styles: [
                "{{asset('assets/builder/css/bootstrap.min.css')}}",
                "{{asset('assets/builder/css/plugin.min.css')}}",
                "{{asset('assets/builder/css/common-style.css')}}",
                "{{asset('assets/builder/css/style.css')}}",
                "{{asset('assets/builder/css/pb-canvas.css?time=' . time())}}",
            ],
            scripts: [
                "{{asset('assets/builder/js/jquery-3.3.1.min.js')}}",
                // "{{asset('assets/builder/js/popper.min.js')}}",
                "{{asset('assets/builder/js/bootstrap.min.js')}}",
                "{{asset('assets/builder/js/pb-plugin.min.js')}}",
                "{{asset('assets/builder/js/pb-custom.js')}}",
                "{{asset('assets/builder/js/pb-default-custom.js')}}"
    ...
    var blockManager = editor.BlockManager;
        blockManager.add('newsletter-section', {
            ...
            render: ({ el }) => {
                const btn = document.createElement('a');
                btn.setAttribute('class', 'block-btn');
                btn.setAttribute('href', '{{route("footer_", ["language" => $lang->code])}}');
                btn.setAttribute('target', '_blank');
                btn.innerHTML = 'Manage';
                el.appendChild(btn);
            }
