...
@section('title', __('Categories Of Projects'))
@section('breadcrumb')
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10">{{ __('Categories Of Projects') }}</h4>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item">{!! Html::link(route('home'), __('Dashboard'), []) !!}</li>
            <li class="breadcrumb-item active">{{ __('Categories Of Projects') }}</li>
        </ul>
    </div>
@endsection
@section('content')
                        ...
                        <td>
                            ...
                            <label class="form-switch">
                                <input class="form-check-input changeStatus" name="custom-switch-checkbox"
                                    ...
                                    data-url="{{ route('projectcategory.status', $category->id) }}" type="checkbox">
                            </label>
                        </td>
