...
<div class="col-md-12">
    <div class="page-header-title">
        <h4 class="m-b-10">{{ __('Project Settings') }}</h4>
    </div>
    <ul class="breadcrumb">
        <li class="breadcrumb-item">{!! Html::link(route('home'), __('Dashboard'), ['']) !!}</li>
        <li class="breadcrumb-item">{{ __('Project Settings') }}</li>
    </ul>
</div>
@endsection
@section('content')
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-lg-8 d-flex align-items-center">
                                            <h5 class="mb-0">{{ __('Project Setting') }}</h5>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('project_name', Utility::getsettings('project_name'), [
                                                    'class' => 'form-control',
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                {{ Form::label('project_detail', __('Project Detail'), ['class' => 'form-label']) }}
                                                {!! Form::textarea('project_detail', Utility::getsettings('project_detail'), [
                                                    'class' => 'form-control',
                                                    'rows' => '3',
