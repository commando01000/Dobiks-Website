...
@section('breadcrumb')
    <div class="col-md-12">
        <div class="page-header-title">
            <h4 class="m-b-10">{{ __('Privacy Settings') }}</h4>
        </div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item">{!! Html::link(route('home'), __('Dashboard'), ['']) !!}</li>
            <li class="breadcrumb-item">{{ __('Privacy Settings') }}</li>
        </ul>
    </div>
@endsection
@section('content')
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-lg-8 d-flex align-items-center">
                                            <h5 class="mb-0">{{ __('Privacy Setting') }}</h5>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                {{ Form::label('privacy_description', __('Privacy Description'), ['class' => 'form-label']) }}
                                                {!! Form::textarea('privacy_description', Utility::getsettings('privacy_description'), [
                                                    'class' => 'form-control',
                                                    'rows' => '3',
...
@push('script')
    ...
    <script>
        CKEDITOR.replace('privacy_description', {
