...
<div class="col-md-12">
    <div class="page-header-title">
        <h4 class="m-b-10">{{ __('Testimonial Settings') }}</h4>
    </div>
    <ul class="breadcrumb">
        <li class="breadcrumb-item">{!! Html::link(route('home'), __('Dashboard'), ['']) !!}</li>
        <li class="breadcrumb-item">{{ __('Testimonial Settings') }}</li>
    </ul>
</div>
@endsection
@section('content')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::textarea('testimonial_detail', Utility::getsettings('testimonial_detail'), [
                                                    'class' => 'form-control',
                                                    'rows' => '3',
