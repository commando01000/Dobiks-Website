...
@section('breadcrumb')
    <div class="col-md-12">
        ...
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('advertisement.index') }}">{{ __('Project') }}</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('embed', null, ['class' => 'form-control','placeholder' => __('Enter Url'),'required' => 'required']) !!}
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
